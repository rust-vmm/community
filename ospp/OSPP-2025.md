...
Dorinda Bassey <dbassey@redhat.com>, Matias Ezequiel Vara Larsen <mvaralar@redhat.com>
...
- This project should extend vhost-device-sound to support audio control operations in compliance with VirtIO Sound 1.3 specification.
...
1. Extended Audio Control Features in vhost-device-sound
    ...
    - Ensure compliance with the VirtIO Sound 1.3 specification.
